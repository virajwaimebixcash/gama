...
import Marriagenewhover from "../../images/Marriagenewhover.svg";
import Marriagenew from "../../images/Marriagenew.svg"
const Smallhoverbox6new = () => {
    ...
    >
        <table className="fullwiselect">
                   <tr>
                    ...
                    <img
                                    src={isHovered ? Marriagenew : Marriagenewhover}
                                    alt="hover-img"
...
export default Smallhoverbox6new;

...
import goalmain from '../../images/goalmain.png'
...
export default function GoalPlanningMain2() {
    const navigate = useNavigate();
        const goToGoalPlannig4 = () => {
          navigate("/GoalPlanningfour");
        };

    const goToGoalPlannig3 = () => {
      navigate("/GoalPlanningthree");
    };
  return (
...
<Grid container spacing={2} className="fullwhites bottsspace">
  <Grid size={{ xs: 12, sm: 12,  md: 6, lg: 6  }} className="nobxandpaper">
    ...
    <Grid size={{ xs: 12, sm: 12,  md: 6, lg: 6  }} className="nobxandpaper">
    <Item>
      <Button variant="contained"  className="Generatebtn genbuttons" onClick={goToGoalPlannig3} sx={{float:'left'}}>
                                  Create Goal
                              </Button>
    </Item>
  </Grid> 

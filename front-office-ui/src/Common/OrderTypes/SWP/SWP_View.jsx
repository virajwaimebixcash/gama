...
function SWP_View({ fixedFormConfig, udfConfig, tableData, setTableData, folioList, tab }) {
  ...
  return (
    <Box sx={{ width: '100%' }}>
      <Box className="maincontent">
        ...
        <PrimaryDetailsSWP  tab={tab} fixedFormConfig={fixedFormConfig} folioList={folioList}  />

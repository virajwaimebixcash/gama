 ...
 */
export const GetPortFolioViewTypeFieldValueReducer = (newState = state, action) => {
    switch (action.type) {
        case "PORTFOLIO_VIEW_TYPE_FIELD_VALUE_REQUEST":
            return {
                ...newState,
        ...
        case "PORTFOLIO_VIEW_TYPE_FIELD_VALUE_REQUEST_SUCCESS":
            return {
                ...newState,
        ...
        case "PORTFOLIO_VIEW_TYPE_FIELD_VALUE_REQUEST_FAILURE":
            return {
                ...newState,

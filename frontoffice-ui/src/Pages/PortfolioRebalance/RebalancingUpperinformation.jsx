...
const RebalancingUpperinformation = ({ headerFields, tabHeaders, setRebalancingUpperData,rebalancingUpperData,viewType, setViewType }) => {
  const navigate = useNavigate();
  const location = useLocation()
  const [portfolioValue, setPortfolioValue] = useState("Discretionary"); // Default selected value
  // const [viewTypeValue, setviewTypeValue] = useState("1"); // Default selected value
  ...
  useEffect(() => {
    setRebalancingUpperData({
      ...
      displayedValues: {
        ...
        viewType// Add dropdown 2
      }
    });
  }, [toggleSwitch, portfolioValue, viewType, selectedModelData]);
          ...
          <tr>
            ...
            <td>
              ...
              >
                ...
                <MenuItem value="1" >By Security</MenuItem>
                <MenuItem value="2">By Portfolio Account</MenuItem>
              </Select>
            </td>
          </tr>
        </table>

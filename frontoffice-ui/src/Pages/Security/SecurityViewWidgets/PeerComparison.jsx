...
const PeerComparison = ({ fundInfoData, fundValue, selectedScheme }) => {
    ...
    const [selectedItems, setSelectedItems] = useState([Number(selectedScheme?.SchemeCode)]);
    ...
    useEffect(() => {
        if (selectedScheme?.SchemeCode) {
            setSelectedItems((prevSelected) => {
                return prevSelected.includes(Number(selectedScheme.SchemeCode))
                    ? prevSelected
                    : [Number(selectedScheme.SchemeCode), ...prevSelected];
            });
        }
                                ...
                                <div className="">
                                    <div className="texleft">
                                        ...
                                        <Button variant="contained" color="primary"
                                            ...
                                            Compare <span className='incount'>{selectedItems.length}</span>
                                        </Button>
                                    </div>
                                </div>
                            </div>
                                                                        ...
                                                                        <tr>
                                                                            <td className="smallchecks1">
                                                                                <Checkboxes1
                                                                                    ...
                                                                                    //     !selectedItems.includes(data.SchemeCode)
                                                                                    // }
                                                                                    disabled={data.SchemeCode === Number(selectedScheme.SchemeCode) || (selectedItems.length === 4 && !selectedItems.includes(data.SchemeCode))}
                                                                                />
                                                                            </td>

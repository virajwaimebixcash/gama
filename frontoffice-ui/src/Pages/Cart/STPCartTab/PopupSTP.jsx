...
// import OtherInformation from '../../Subscription/SIPCartTab/OtherInformation';
// import IconRadioButtons from '../../Subscription/SIPCartTab/IconRadioButtons';

const PopupSTP = ({stpManagerActionData}) => {
  ...
  const handleCloseAll = () => {
    ...
    const sortedActions = stpManagerActionData
    ...
    <div>
      ...
      <Dialog open={openPopup === 1} onClose={handleCloseAll}>
        <div className='modelpopup paddingpanl'>
          ...
          {/* <DialogTitle><ErrorOutlineIcon />Are you sure you want to modify STP?</DialogTitle>  */}

          <Typography variant="h6" sx={{ display: 'flex', alignItems: 'center', }}>
            <ErrorOutlineIcon sx={{ color: 'orange', marginRight: '8px' }} />
            <span className='textmodi'> Are you sure you want to skip STP?</span>
          </Typography>
          <DialogActions sx={{
      ...
      <Dialog open={open} onClose={handleClose} maxWidth="xl">
        <h2 class="headingtop pl23">Modify STP</h2>
  ...
  //     <Dialog open={open} onClose={handleClose} maxWidth="xl">
  //       <h2 className="headingtop pl23">Modify STP</h2>

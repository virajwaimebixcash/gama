...
const PopupSIP = ({ sipManagerActionData }) => {
  ...
  const fetchActions = sipManagerActionData
  ...
  const sortedActions = sipManagerActionData
    ...
    <div>
      ...
      <Dialog open={openPopup === 1} onClose={handleCloseAll}>
        <div className='modelpopup paddingpanl'>
          ...
          {/* <DialogTitle><ErrorOutlineIcon />Are you sure you want to modify SIP?</DialogTitle>  */}

          <Typography variant="h6" sx={{ display: 'flex', alignItems: 'center', }}>
            <ErrorOutlineIcon sx={{ color: 'orange', marginRight: '8px' }} />
            <span className='textmodi'> Are you sure you want to Skip SIP?</span>
          </Typography>
          <DialogActions sx={{
      ...
      <Dialog open={open} onClose={handleClose} maxWidth="xl">
        <h2 className="headingtop pl23">Modify SIP</h2>

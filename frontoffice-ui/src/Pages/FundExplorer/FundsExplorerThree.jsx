...
import FundExplorerSkeleton from '../../Common/Skeletons/FundExplorerSkeleton';
...
export default function FundsExplorerThree() {
  ...
  const getUniverseData = async () => {
    ...
    try {
      ...
      console.error("Error fetching fund universe data:", error);
    } finally {
      setLoading(false);
    }
  }

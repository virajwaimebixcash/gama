...
import PrimaryDetailsFundSwitch from './PrimaryDetailsFundSwitch';
import CreateDynamic from '../../UdfRenderer/CreateDynamic';

function FundSwitchView({ fixedFormConfig, udfConfig, tableData, setTableData, folioList, tab,cartList }) {
  ...
  return (
    <Box sx={{ width: '100%' }}>
      <Box className="maincontent">
        ...
        <PrimaryDetailsFundSwitch tab={tab} fixedFormConfig={fixedFormConfig} folioList={folioList} cartList={cartList} />

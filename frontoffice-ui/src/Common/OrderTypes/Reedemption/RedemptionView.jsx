...
import RedemptionPrimaryDetails from './PrimaryDetailsRedemption';
import CreateDynamic from '../../UdfRenderer/CreateDynamic';

function RedemptionView({ fixedFormConfig, udfConfig, tableData, setTableData, folioList, cartList, tab, isOrderAmountDisabled }) {
  ...
  return (
    <Box sx={{ width: '100%' }}>
      <Box className="maincontent">
        ...
        <RedemptionPrimaryDetails tab={tab} fixedFormConfig={fixedFormConfig} folioList={folioList} cartList={cartList} isOrderAmountDisabled={isOrderAmountDisabled} />

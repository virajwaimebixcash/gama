...
import PrimaryDetailsSTP from './PrimaryDetailsSTP';
import CreateDynamic from '../../UdfRenderer/CreateDynamic';

function STPView({ fixedFormConfig, udfConfig, tableData, setTableData, folioList, tab }) {
    ...
    return (
        <Box sx={{ width: '100%' }}>
            <Box className="maincontent">
                ...
                <PrimaryDetailsSTP tab={tab} fixedFormConfig={fixedFormConfig} folioList={folioList} />
